<template>
    ...
    <div class="title">
      <div class="title-1">
        <button class="AddTwoSimulationTestPaper" @click="to">+添加模拟试卷</button>
        <template>
