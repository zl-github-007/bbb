<template>
    <div id="TwoShortAnswerQuestions">
        <div class="header">
      <div class="header-1">
    ...
    <div class="title">
      <div class="title-1">
        <button class="AddTwoShortAnswerQuestions" @click="to">+添加简答题</button>
        <template>
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="content" label="题目内容" width="300" align="center"></el-table-column>
            <el-table-column prop="answer" label="正确答案" width="300" align="center"></el-table-column>
